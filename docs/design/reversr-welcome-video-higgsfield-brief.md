...
7. First run one constrained variant only:
...
8. Claude rejects the candidate immediately if the first 4 seconds do not show the two halves and their visible closure. Only then should secondary variants be explored.
