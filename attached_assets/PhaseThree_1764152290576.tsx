...
import { Code, Terminal, CheckCircle, Download, View, Box, ArrowRight, RefreshCw, Image as ImageIcon, Layers, FileJson } from 'lucide-react';
...
const PhaseThree: React.FC<Props> = ({ innovation, onComplete, onReset, context }) => {
  ...
  // 1. Auto-generate specs on mount
  ...
  // Initial Loading Screen (Architect)
